...
export const dataTable: Exercise = {
  ...
  lede: "Una tabla con datos de usuarios que permite ordernar por columna y pagination. Usa useMemo para optimizar el ordenamiento y paginación.",
  difficulty: "advanced",
  objectives: [
    ...
    " useMemo para-ordernar datos según sortCol y sortDir",
